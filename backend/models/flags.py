...
class YellowFlags:
    ...
    LARGE_PRE_JOIN_TRANSFER = "LARGE_PRE_JOIN_TRANSFER"
    UNUSUAL_WALLET_ACTIVITY = "UNUSUAL_WALLET_ACTIVITY"
    ALLIED_NEGATIVE_STANDINGS = "ALLIED_NEGATIVE_STANDINGS"
    ENEMY_FACTION_STANDING = "ENEMY_FACTION_STANDING"
...
class GreenFlags:
    ...
    ALLIED_STANDINGS = "ALLIED_STANDINGS"
